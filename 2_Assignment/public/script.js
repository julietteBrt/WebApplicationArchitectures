...
function saveToFolder(base64URL){
    // Building our json object
    let image = {
        user: username,
        date: Date.now(),
        path: base64URL
    }
    // sending the object to the save endpoint on the server
    fetch(url + 'save', {
        headers:{
    ...
    user_message.innerHTML = '<span>Image successfully saved.</span>'
}
